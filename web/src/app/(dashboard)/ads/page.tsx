...
function MetaAdsLoadingScreen({ message = 'Making your Meta Ads data ready' }: { message?: string }) {
    const metricSkeletons = ['Spend', 'Reach', 'CTR', 'Conversions', 'CPM', 'ROAS'];
            ...
            <div style={{
                ...
                <div className="page-header" style={{ marginBottom: 20 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 }}>
                        <div>
                            <div style={{ width: 190, height: 28, borderRadius: 7 }} className="skeleton" />
                            <div style={{ width: 260, height: 13, borderRadius: 6, marginTop: 10 }} className="skeleton" />
                        </div>
                        <div style={{ width: 220, height: 40, borderRadius: 10 }} className="skeleton" />
                    </div>
                </div>

                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
                    {[0, 1, 2].map((i) => (
                        <div key={i} style={{ width: i === 0 ? 142 : 116, height: 34, borderRadius: 999 }} className="skeleton" />
                    ))}
                </div>
                ...
                <div className="grid-metrics" style={{ marginBottom: 24, gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))' }}>
                    {metricSkeletons.map((label) => (
                        <div key={label} className="metric-card" style={{ padding: 16 }}>
                            <div style={{ width: 36, height: 36, borderRadius: 10, marginBottom: 14 }} className="skeleton" />
                            <div style={{ width: '68%', height: 24, borderRadius: 7, marginBottom: 10 }} className="skeleton" />
                            <div style={{ width: '48%', height: 12, borderRadius: 6 }} className="skeleton" />
                        </div>
                    ))}
                </div>

                <div style={{ display: 'flex', gap: 8, marginBottom: 24, flexWrap: 'wrap' }}>
                    {['Overview', 'Funnel', 'Campaigns', 'Audience'].map((label) => (
                        <div key={label} style={{ width: 110, height: 36, borderRadius: 999 }} className="skeleton" />
                    ))}
                </div>

                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                    <div className="card" style={{ height: 240 }}>
                        <div style={{ width: 180, height: 18, borderRadius: 7, marginBottom: 18 }} className="skeleton" />
                        <div style={{ height: 170, borderRadius: 10 }} className="skeleton" />
                    </div>
                    <div className="card" style={{ height: 240 }}>
                        <div style={{ width: 155, height: 18, borderRadius: 7, marginBottom: 18 }} className="skeleton" />
                        <div style={{ display: 'grid', gap: 12 }}>
                            {[0, 1, 2, 3].map((i) => (
                                <div key={i} style={{ height: 28, borderRadius: 8 }} className="skeleton" />
                            ))}
                        </div>
                    </div>
                </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ textAlign: 'left' }}>
                        <div style={{ color: '#f8fafc', fontSize: 13, fontWeight: 700, lineHeight: 1.2 }}>
                            {message}
                        </div>
                        <div style={{ color: '#94a3b8', fontSize: 11, marginTop: 2 }}>
                            Syncing live Meta signals
                        </div>
                    </div>
