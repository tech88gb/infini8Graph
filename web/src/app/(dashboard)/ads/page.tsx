            ...
            {activeTab === 'deep' && (
                <div style={{ display: 'grid', gap: 20 }}>
                    {deepDiagnosticsLoading ? (
                        ...
                        <>
                            <div style={{ padding: '14px 16px', borderRadius: 12, background: 'rgba(99, 102, 241, 0.08)', color: 'var(--muted)', fontSize: 13 }}>
                                Funnel diagnostics now live in <strong style={{ color: 'var(--foreground)' }}>Conversion Funnel</strong> so this tab can stay focused on video and placement forensics.
                            </div>
